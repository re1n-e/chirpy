...
const updatePackageById = `-- name: UpdatePackageById :exec
UPDATE users
SET is_chirpy_red = TRUE
WHERE id = $1
`

func (q *Queries) UpdatePackageById(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, updatePackageById, id)
	return err
}
